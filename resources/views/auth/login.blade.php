...
<body class="bg-gradient-to-br from-blue-100 to-white min-h-screen flex items-center justify-center px-4">
    <div class="login-box bg-white/90 shadow-2xl rounded-2xl w-full max-w-md p-8 md:p-10">
        <h1 class="text-3xl md:text-4xl font-bold text-center text-gray-800 mb-8">
            Selamat Datang <a href="{{ route('home') }}">👋</a>
        </h1>
        ...
        <form method="POST" action="{{ route('login') }}" class="space-y-5" autocomplete="off">
            ...
            <div>
                ...
                <input type="email" name="email" required autofocus
                    class="w-full border border-gray-300 px-4 py-2 rounded-md focus:ring-blue-500 focus:border-blue-500 shadow-sm" />
            </div>
            ...
            <div>
                ...
                <div class="relative">
                    <input type="password" id="password" name="password" required
                        class="w-full border border-gray-300 px-4 py-2 rounded-md pr-10 focus:ring-blue-500 focus:border-blue-500 shadow-sm">

                    <!-- Toggle icon wrapper -->
                    <button type="button" id="togglePassword"
                        class="absolute inset-y-0 right-0 flex items-center px-3 text-gray-500 hover:text-gray-700">
                        <span id="passwordIconWrap" class="inline-flex items-center"></span>
                    </button>
                </div>
            </div>
        ...
        <p class="mt-6 text-sm text-center text-gray-500">
            Belum punya akun?
            <a href="#" class="text-blue-600 hover:underline font-medium">Daftar</a>
        </p>
    </div>
</body>
</html>
